...
import com.example.login_assignment.databinding.ActivitySignUpBinding
   ...
   override fun onCreate(savedInstanceState: Bundle?) {
    ...
    fun signup(view: View){
        ...
        if(!isValidPasswordFormat(pswd)){
            Toast.makeText(this,"Password must contain 7 Characters, 1 UpperCase Alphabet, 1 SpecialCharacter and Numeric values",Toast.LENGTH_LONG).show()
            return
        }
